        ...
        <div class="row">
          <div class="col-md-12">
            <div class="post-heading text-center">
              ...
              <br>
              <br>
                <form class="form-inline header-job-search justify-content-center">
                    <div class="input-group left-input">
                        <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-search"></i></span>
                        <input type="text" class="form-control" placeholder="Titulo" aria-label="Titulo" aria-describedby="sizing-addon1">
                    </div>
                    <div class="input-group right-input">
                      <span class="input-group-addon" id="sizing-addon2"><i class="fa fa-map-marker"></i></span>
                      <input type="text" class="form-control" placeholder="Ciudad" aria-label="Ciudad" aria-describedby="sizing-addon2">
                    </div>
